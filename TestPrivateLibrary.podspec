#
#  Be sure to run `pod spec lint TestPrivateLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of TestPrivateLibrary."
  ...
  s.source       = { :git => "https://github.com/dougdiego/TestPrivateLibrary.git", :tag => "0.0.1" }
